;;; dune-dark-theme.el --- Theme

;; Copyright (C) 2024 , Infilit
...
;;; Commentary:
;;; dune-dark theme created by Infilit in 2024
...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(org-level-1 ((,class (:bold t :foreground ,hd1 :height 1.1))))
   `(org-level-2 ((,class (:bold nil :foreground ,hd2))))
   ...
   `(org-block ((,class (:foreground ,fg3 :background ,bg2))))
...
(provide-theme 'dune-dark)

;; Local Variables:
;; no-byte-compile: t
;; End:

;;; dune-dark-theme.el ends here
